...
The system is pattern-based, not a real-time fact checker
...
May not perform well for:
            ...
            Does not verify actual truth of news.
...
🚀 Future Scope
            ...
            Use of advanced models like BERT (if allowed)
